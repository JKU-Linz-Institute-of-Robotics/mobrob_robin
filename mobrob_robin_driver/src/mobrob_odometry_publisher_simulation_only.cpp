...
{
  //  init node
  ros::init(argc, argv, "mobrob_odometry_publisher");
  ros::NodeHandle n;
  ...
  ros::Subscriber base_subscriber = n.subscribe( "/mobrob_robin/joint_states", 1000, base_callback );
  ros::Subscriber vel_subscriber = n.subscribe( "/mobrob_robin/base/cmd_vel", 1000, vel_callback );
